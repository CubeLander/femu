...
- 总实施计划：`docs/legacy/opensbi-linux-rootfs-implementation-plan.md`
- 双核 Linux 调通技术总结：`docs/legacy/smp-linux-bringup-technical-summary.md`
- SMP threaded 内存语义清单：`docs/legacy/smp-threaded-memory-semantics-checklist.md`
- 块级 JIT 启动计划：`docs/legacy/block-jit-kickoff-plan.md`
- Phase-1 Boot Contract：`docs/legacy/boot-contract.md`
